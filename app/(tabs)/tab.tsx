...
import DriverScreen from './(driver)/driver';
...
export default function TabScreen() {
 ...
 function TabNavigator() {
    ...
    return (
        ...
        >
            <Tab.Screen name='Commute' component={TripScreen} />
            <Tab.Screen name='Fleet' component={FleetScreen} />
            {/* <Tab.Screen name='Report' component={ReportLayout} /> */}
            <Tab.Screen name='Road Safety' component={DriverScreen} />
