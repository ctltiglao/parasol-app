...
import { driverErrOptions, genderOptions, injuryOptions, involvementOptions, seatbeltOptions } from '@/assets/values/strings';
...
export default function AdultsScreen() {
    ...
    const [ inputFirst, setInputFirst ] = useState('New');
    const [ inputMiddle, setInputMiddle ] = useState('');
    const [ inputLast, setInputLast ] = useState('Person');
